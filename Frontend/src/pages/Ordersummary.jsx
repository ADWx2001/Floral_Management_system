    ...
    <div className="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
        <div className="mt-4 py-2 text-xs sm:mt-0 sm:ml-auto sm:text-base">
            ...
            <ul className="relative flex w-full items-center justify-between space-x-2 sm:space-x-4 font-cinzel">
                ...
                <a className="flex h-6 w-6 items-center justify-center rounded-full bg-pink-200 text-xs font-semibold text-pink-700" href="/cart"><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    ...
    {(!currentUser) ? (
      <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto pt-8">
          ...
          <div className="text-center mt-5 mb-10">
              <Link to="/sign-in">
                <span className="p-2 bg-pink-200 rounded px-5 hover:bg-primary hover:text-white">
                  Log in
                </span>
              </Link>
          </div>
        ...
        <div className="mt-10 bg-pink-50 px-4 pt-8 lg:mt-0 font-cinzel">
            ...
            <form action="https://sandbox.payhere.lk/pay/checkout" method="post">
              <div className="">
              <label htmlFor="email" className="mt-4 mb-2 block text-sm font-semibold">First Name</label>
              <div className="relative">
              ...
              <label htmlFor="email" className="mt-4 mb-2 block text-sm font-semibold">Last Name</label>
              <div className="relative">
              ...
              <label htmlFor="card-holder" className="mt-4 mb-2 block text-sm font-semibold">Phone</label>
              <div className="relative">
              ...
              <label htmlFor="billing-address" className="mt-4 mb-2 block text-sm font-semibold">Address</label>
              <div className="flex flex-col sm:flex-row">
                  <div className="relative flex-shrink-0 sm:w-7/12">
                      <input type="text" id="billing-address" name="address" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-md shadow-sm outline-none focus:z-10 focus:border-primary focus:ring-primary" onChange={(e) => setpayHereFormData({ ...payHereFormData, address: e.target.value })} placeholder="Street Address" required/>
                  ...
                  <input type="text" name="city" className="w-full rounded-md border border-gray-200 px-4 py-3 text-md shadow-sm outline-none focus:z-10 focus:border-primary focus:ring-primary" onChange={(e) => setpayHereFormData({ ...payHereFormData, state: e.target.value })} placeholder="State" required/>
                
                  <input type="text" name="billing-zip" className="flex-shrink-0 rounded-md border border-gray-200 px-4 py-3 text-md shadow-sm outline-none sm:w-1/6 focus:z-10 focupinkrder-blue-500 fopinkring-blue-500" onChange={(e) => setpayHereFormData({ ...payHereFormData, zip: e.target.value })} placeholder="ZIP"  required/>
              </div><br />
              ...
              <button type="submit"  onClick={handlePayHerePayment} className="rounded-full w-full  py-3 px-6 text-center justify-center items-center bg-primary font-semibold text-lg text-white flex transition-all duration-500 hover:bg-pink-500">Place Order</button>
              {publishError && (
