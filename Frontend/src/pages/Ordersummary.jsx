    ...
    <>
          ...
          <div className="relative">
            <ul className="relative flex w-full items-center justify-between space-x-2 sm:space-x-4 font-cinzel">
              <li className="flex items-center space-x-3 text-left sm:space-x-4">
                <a className="flex h-6 w-6 items-center justify-center rounded-full bg-pink-200 text-xs font-semibold text-pink-700" href="/cart">
      ...
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        ...
        {(!currentUser) ? (
          ...
          <div className="mt-10 bg-pink-50 px-4 pt-8 lg:mt-0 font-cinzel pb-5">
            ...
            <form onSubmit={handlePayHerePayment}>
              ...
              <br />
              <button type="submit" className="rounded-full w-full py-3 px-6 text-center justify-center items-center bg-primary font-semibold text-lg text-white flex transition-all duration-500 hover:bg-pink-500">Place Order</button>
              {publishError && (
