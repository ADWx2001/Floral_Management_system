    ...
    <>
      <div className="mx-auto">
        ...
        >
          ...
          <video
            ...
            poster="/path/to/your/poster.jpg"  // optional, shows an image before the video starts
           style={{height:"600px"}}>
            Your browser does not support the video tag.
          </video>
          <div className="absolute top-28 left-0 w-full bg-black opacity-25" style={{height:"600px"}}></div>
        </div>
      ...
      <div className="flex justify-between dark:bg-gray-800">
        <div className="w-full ">
          ...
          <div>
            <h1 className="text-3xl font-semibold font-cinzel mx-32 pt-10 uppercase" style={{color:"#D63096"}}>
              Our Popular Events
            </h1>

            <div className="flex flex-wrap justify-center gap-10 mx-20 p-5">
              {events.map((singleItem) => (
                <div className="flex justify-center py-8 font-cinzel" key={singleItem._id}>
