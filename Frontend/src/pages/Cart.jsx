          ...
          <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
              ...
              <div className="flex items-center flex-col sm:flex-row justify-center gap-3 mt-8">
                  ...
                  <Link to='/Ordersummary'>
                    <button
                        className="rounded-full w-full max-w-[280px] py-4 px-6 text-center justify-center items-center bg-indigo-600 font-semibold text-lg text-white flex transition-all duration-500 hover:bg-indigo-700">Continue
                        to Payment
