    ...
    <div className="p-3 max-w-3xl mx-auto min-h-screen">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <div className='flex flex-col gap-4 sm:flex-row justify-between'>
          ...
          <TextInput type="text" placeholder="Delivery Time" id="deliveryTime" onChange={(e) => setFormData({ ...formData, deliveryTime: e.target.value })} />
          <TextInput type="text" placeholder="Supplier" id="supplier" onChange={(e) => setFormData({ ...formData, supplier: e.target.value })} />
        </div>
