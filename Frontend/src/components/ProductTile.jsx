...
export default function ProductTile({img, productName, deliveryTime, availability , price}) {
  return (
    <div className="max-w-sm rounded overflow-hidden shadow-xl hover:border">
          <img className="w-full rounded-2xl p-3" src={img} alt="Sunset in the mountains"></img>
          ...
          <div className="flex p-3 mx-auto justify-between">
