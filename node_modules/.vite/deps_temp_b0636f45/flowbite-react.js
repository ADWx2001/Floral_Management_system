...
import {
  ...
  HiSun,
  HiX
} from "./chunk-4V43JFKL.js";
import "./chunk-MABYAISA.js";
import {
  require_react_dom
...
function Popover({ children, content, theme: customTheme = {}, arrow: arrow4 = true, trigger = "click", initialOpen, open: controlledOpen, onOpenChange: setControlledOpen, placement: theirPlacement = "bottom", ...props }) {
  const [uncontrolledOpen, setUncontrolledOpen] = (0, import_react35.useState)(Boolean(initialOpen));
  ...
  if (!(0, import_react35.isValidElement)(children)) {
    throw Error("Invalid target element");
  }
  const target = (0, import_react35.useMemo)(() => {
    return (0, import_react35.cloneElement)(children, getReferenceProps({
      ref,
...
var SidebarContext = (0, import_react43.createContext)(void 0);
function useSidebarContext() {
  const context = (0, import_react43.useContext)(SidebarContext);
  if (!context) {
