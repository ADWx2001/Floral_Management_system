...
var SiderContext = React33.createContext({});
...
var Sider = React33.forwardRef((props, ref) => {
  const {
  ...
  const {
    siderHook
  } = (0, import_react15.useContext)(LayoutContext);
  const [collapsed, setCollapsed] = (0, import_react15.useState)("collapsed" in props ? props.collapsed : defaultCollapsed);
  const [below, setBelow] = (0, import_react15.useState)(false);
  ...
  const responsiveHandlerRef = (0, import_react15.useRef)();
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React33.createElement("span", {
      onClick: toggle,
    ...
    }, trigger || React33.createElement(BarsOutlined_default, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React33.createElement(RightOutlined_default, null) : React33.createElement(LeftOutlined_default, null),
      collapsed: reverseArrow ? React33.createElement(LeftOutlined_default, null) : React33.createElement(RightOutlined_default, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React33.createElement("div", {
    ...
    return React33.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return React33.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider());
});
if (true) {
...
function generator(_ref) {
  ...
  return (BasicComponent) => {
    const Adapter = React34.forwardRef((props, ref) => React34.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React34.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    suffixCls,
    className,
  ...
  return wrapSSR(React34.createElement(TagName, Object.assign({
    className: (0, import_classnames3.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId, cssVarCls),
    ref
  }, others)));
});
var BasicLayout = React34.forwardRef((props, ref) => {
  const {
    direction
  } = React34.useContext(ConfigContext);
  const [siders, setSiders] = React34.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
  ...
  return wrapCSSVar(React34.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React34.createElement(Tag, Object.assign({
    ref,
...
//# sourceMappingURL=chunk-TPVIMKWO.js.map
